                        ...
                        <div className="flex">
                            <div className="shrink-0 flex items-center">
                                <Link href="/" className="flex items-center gap-2">
                                    <div className="bg-emerald-600 text-white p-1.5 rounded-lg font-black text-xl">S</div>
                                    <span className="font-bold text-emerald-900 uppercase tracking-tight">Sabilillah</span>
                                </Link>
                            </div>
